...
use AppAnest\Model\legalentity as Model;

class legalentity extends \Smart\Data\Cache {
    ...
    public function selectLike(array $data) {
        ...
        $sql = "SELECT " .implode(',', $f). " FROM person WHERE typeperson = 'L' and ( " . implode(' OR ', $p) . " )";
    ...
    public function selectCode(array $data) {
        ...
        $sql = "
            ...
            FROM
                person p
                inner join legalentity le on ( le.id = p.id )
            WHERE p.id = :id";
