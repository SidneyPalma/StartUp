...
trait TfileSerialize {
    ...
    public function nullFile() {
        ...
        $affectedRows = $this->exec("update $post->tableName set filedata = null, fileinfo = null where id = $post->id");
    ...
    private function loadData() {
        ...
        $result = $this->fetchAll("select filedata, fileinfo from $post->tableName where id = $post->id");
...
//        $ext = pathinfo($imgData, PATHINFO_EXTENSION);
