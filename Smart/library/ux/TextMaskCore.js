...
/**
 * MODO DE USO DO Smart.ux.TextMaskCore
 *
 * Métodos:
...
Ext.define('Smart.ux.TextMaskCore', {

	alternateClassName: ['Smart.TextMaskCore'],
...
/**
* Aqui temos um Sigleton para a mascara, use para formatações rápidas, exemplo
*   Smart.TextMask.setMask('99/99/9999').mask('10102010'); //Vai retornar 10/10/2010
**/
Smart.TextMask = new Smart.ux.TextMaskCore('', false);

/**
* Aqui temos um Sigleton para a mascara de valores, use para formatações rapidas, exemplo
*   Smart.MoneyMask.setMask('R$#9.990,00').mask('100'); //Vai retornar R$100,00
**/
Smart.MoneyMask = new Smart.ux.TextMaskCore('', true);
...
*     header: 'Telefone',
*     dataIndex: 'fone',
*     renderer: Smart.maskRenderer('(099) 9999-9999',false)
*   }
    return function (v) {
**/
Smart.maskRenderer = function (mask, money) {
    return function (v) {
        return (money === true ) ? Smart.MoneyMask.setMask(mask).mask(v) : Smart.TextMask.setMask(mask).mask(v);
    }
}